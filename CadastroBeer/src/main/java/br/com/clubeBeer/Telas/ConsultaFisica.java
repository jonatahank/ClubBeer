		...
		tabela.addMouseListener(new MouseAdapter() {  
	            public void mouseClicked(MouseEvent e) {  
	                ...
	                janela.setVisible(false);
	                    ...
	                    teste.cpf.setText(tabela.getValueAt (row, 1).toString());
	                    teste.rg.setText(tabela.getValueAt(row, 2).toString());
	                    ...
	                    teste.id.setText(tabela.getValueAt(row, 14).toString());
	...
	private static void preparaBotaoCarregar() {
		...
		botaoCarregar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				List<PessoaFisica> pessoas = dao.Listar();
				TabelaModelo ntm = new TabelaModelo(pessoas);
				tabela.setModel(ntm);
